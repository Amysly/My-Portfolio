    ...
    return ( 
        ...
        <div className="text-white p-4">
          ...
          <div className="profile-div mb-8">
            <img  src="/images/amara.jpg" className="profile-pic mt-8"/>
            </div>
            <div className="font-serif">
              <h1 className="text-3xl lg:text-5xl  mb-8 text-yellow-400 font-serif ">Amarachi Obiegue</h1>
              <p className="sm:text-2xl lg:text-3xl">I'm a passionate fontend developer</p>
          ...
          <div className="flex justify-center space-x-4 mt-10 mb-10 sm:text-2xl lg:text-5xl">
