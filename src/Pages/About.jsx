        ...
        <div className="pt-4 px-4 background">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:p-2 md:p-10 lg:p-20">
            ...
            <div className="" data-aos="slide-left">
              ...
              <h5 className="text-yellow-400 text-2xl lg:text-3xl font-serif mb-4">Frontend Developer</h5>
              <p className="text-white font-serif mb-4 leading-8 sm:text-base lg:text-2xl">
                  ...
                  Html5, Css3, Bootstrap 4 and 5, Tailwind css and javascript. i have worked on creating responsive
                   layouts and adding interactive features through javascript. I recently started learning react to
